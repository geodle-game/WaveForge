...
const WEAPON_UPGRADES = [
    ...
    { id: 'shuriken_double', name: 'Twin Shurikens', description: 'Throw 2 shurikens at once', icon: '⭐⭐', weaponId: 'shuriken', effect: { pelletCount: 2, spreadAngle: 20 } },
    { id: 'shuriken_pierce', name: 'Piercing Shurikens', description: 'Shurikens pierce through 1 enemy', icon: '🔩', weaponId: 'shuriken', effect: { pierceCount: 1 } },
